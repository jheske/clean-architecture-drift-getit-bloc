...
class _$SongModelImpl extends _SongModel {
  ...
  @override
  String toString() {
    return 'SongModel(id: $id, name: $name, genre: $genre, album: $album, duration: $duration, artistId: $artistId)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, name, genre, album, duration, artistId);
